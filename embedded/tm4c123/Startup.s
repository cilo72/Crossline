...
;******************************************************************************
;
; <q.0> Enable Stack Check
;           <0=> do not initialze main stack
;           <1=> initialize main stack with 0xA5
; <i> Initialize the main stack for stack overflow check with 'Stack Check Pattern'.
; <i> The main stack is used during firmware startup and as Main Stack Pointer (MSP)
; <i> when FreeRTOS is running for interrupt handling (ARM handler mode).
;******************************************************************************
StackCheck      EQU     1

;******************************************************************************
;
; <o> Stack Check Pattern (one byte) <0x0-0xFF>
; <i> Defines the stack initialization pattern.
;******************************************************************************
CheckPattern    EQU     0xA5
...
__initial_sp
    ...
    ELSE
        AREA    |.aSTACK|, READWRITE, ALIGN=3
        EXPORT HandlerStackMem
HandlerStackMem
StackMem
        FILL    Stack, CheckPattern, 1
__initial_sp
        EXPORT HandlerStackEnd
HandlerStackEnd
    ENDIF
